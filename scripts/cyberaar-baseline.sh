...
<footer>
  <div class="footer-logo">
    <a href="https://github.com/cyberaar/cyberaar-toolkit" target="_blank">
      <img src="data:image/png;base64,${LOGO_WHITE_VAR}" alt="CyberAar logo">
    </a>
  </div>
  <div class="footer-text">
    Generated by <a href="https://github.com/cyberaar/cyberaar-toolkit" target="_blank">CyberAar Baseline Checker v${SCRIPT_VERSION}</a><br>
